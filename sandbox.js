...
function crearClasePersona() {
    class Persona {
      ...
      getFriends() {
        ...
        // Tu código aca:
        return this.amigos.map(objeto => objeto[nombre]);
      ...
      getPromedioEdad() {
        ...
        var contador = 0;
        var total = 0;
        for (var i = 0; this.amigos[i] != undefined; i++){
                total = total + this.amigos[i].edad;
                contador++;
            }
  ...
  const Persona = crearClasePersona();
        const persona = new Persona('toni', 23, ['futbol'], [{nombre: 'martin', edad: 31}, {nombre: 'Emi', edad: 25}]);
